...
async FCFEMethod(inputs:any,worksheet1:any,worksheet2:any): Promise<any> {
 ...
 const result=await this.FCFEAndFCFF_Common(inputs,worksheet1,worksheet2,discountingFactor);
 return result;
  } 
  async FCFFMethod(inputs:any,worksheet1:any,worksheet2:any): Promise<any> {
    const {costOfDebt,costOfDebtValue,capitalStructure}=inputs;
      ...
      async FCFEAndFCFF_Common(inputs:any,worksheet1:any,worksheet2:any,discountingFactor:number): Promise<any>{
