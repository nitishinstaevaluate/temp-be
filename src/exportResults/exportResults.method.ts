        ...
        columns: [
          {
            ...
            text: [
              ...
              },
              {
                ...
                ).format('MMM D, YYYY')}\nMethod: ${valuation.model} at ${valuation.inputData.discountingPeriod}`,
                style:'header'
              },
            ],
          },
  ...
  valuationData.valuation.map((obj: any, index: number) => {
    ...
    if (obj.particular === 'pbRatio') {
      ...
      table2.push([
        ...
        obj.pbSharesAvg?obj.pbSharesAvg:"",        // Decimal not required
        obj.pbSharesMed?obj.pbSharesMed:"",        // Decimal not required
      ]);
      table2.push([
        '',
